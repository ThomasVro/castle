...
exports.get = function() {
  ...
  .then(function(results){
    jsonfile.writeFile('JSONFiles/restaurants.json', results, {spaces: 2}, function(err){
      if(err){
        console.error(err);
      }
    });
...
exports.getAllAddresses = function(restaurants) {
  ...
  .then(function(restaurants){
    jsonfile.writeFile('JSONFiles/addressesRestaurants.json', restaurants, {spaces: 2}, function(err){
      if(err){
        console.error(err);
      }
    });
